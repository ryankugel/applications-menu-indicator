...
public class ApplicationsMenu.Widgets.SearchItem : Gtk.ListBoxRow {
    ...
    public ApplicationsMenu.Views.ResultType result_type { public get; construct; }

    public Gtk.Image icon { public get; private set; }
    public string? app_uri { get; private set; }

    private ApplicationsMenu.Widgets.AppContextMenu menu;

    private Gtk.Label name_label;
    private Cancellable? cancellable = null;

    public SearchItem (Backend.App app, string search_term = "", ApplicationsMenu.Views.ResultType result_type = ApplicationsMenu.Views.ResultType.UNKNOWN) {
        Object (
            app: app,
    ...
    construct {
        string markup;
        if (result_type == ApplicationsMenu.Views.ResultType.TEXT) {
            markup = app.match.title;
        } else if (result_type == ApplicationsMenu.Views.ResultType.APP_ACTIONS) {
        ...
        if (result_type != ApplicationsMenu.Views.ResultType.APP_ACTIONS) {
    ...
    public bool create_context_menu (Gdk.Event e) {
        ...
        menu = new ApplicationsMenu.Widgets.AppContextMenu (app.desktop_id, app.desktop_path);
