...
public class ApplicationsMenu.Widgets.AppContextMenu : Gtk.Menu {
    ...
    private ApplicationsMenu.Backend.SwitcherooControl switcheroo_control;
    ...
    construct {
        switcheroo_control = new ApplicationsMenu.Backend.SwitcherooControl ();
