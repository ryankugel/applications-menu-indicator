...
#if HAS_PLANK
public class ApplicationsMenu.Views.MenuView : Gtk.Grid, Plank.UnityClient {
#else
public class ApplicationsMenu.Views.MenuView : Gtk.Grid {
#endif
    ...
    public ApplicationsMenu.Backend.AppSystem app_system;
    public Gtk.SearchEntry search_entry;
    public Gtk.Stack stack;
    public Granite.Widgets.ModeButton view_selector;

    private ApplicationsMenu.Views.GridView grid_view;
    private ApplicationsMenu.Views.SearchView search_view;
    private ApplicationsMenu.Views.CategoryView category_view;
    private ApplicationsMenu.Backend.SynapseSearch synapse;
    ...
    static construct {
        settings = new GLib.Settings ("com.github.ryankugel.applications-menu");
    }

    construct {
        app_system = new ApplicationsMenu.Backend.AppSystem ();
        synapse = new ApplicationsMenu.Backend.SynapseSearch ();
        screen = get_screen ();
        ...
        grid_view = new ApplicationsMenu.Views.GridView ();
        category_view = new ApplicationsMenu.Views.CategoryView (this);
        search_view = new ApplicationsMenu.Views.SearchView ();
        ...
        // Switch to category view or regular icon view depending on settings
